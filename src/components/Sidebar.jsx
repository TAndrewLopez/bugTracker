...
export default function () {
  ...
  return (
    <div className="w-full md:w-96 h-full fixed text-center bg-darkGrey py-8 flex flex-col">
      <h1 className="text-4xl font-bold text-light mb-10">
        <Link className="p-1">Bug-Tracker </Link>
      </h1>
      <ul className="flex-1">
        <li className="text-2xl text-light hover:bg-accent py-2 transition-all ease-in-out duration-300">
